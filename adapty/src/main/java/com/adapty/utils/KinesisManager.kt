...
import com.adapty.api.ApiClient.Companion.PUT
import com.adapty.api.TAG
...
class KinesisManager(private val preferenceManager: PreferenceManager) {
    ...
    private val kinesisStream = "adapty-data-pipeline-dev"
    private val cognitoIdentityPoolId = "us-east-1:45628167-4616-47a0-a5a5-e37b458d024c"
    ...
    fun trackEvent() {
        ...
        records.add(AwsRecordModel(Base64Utils.encode(dataStr.toByteArray()).replace("\n", ""), preferenceManager.installationMetaID))
